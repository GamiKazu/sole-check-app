...
# =========================================================
    ...
    st.markdown(
        ...
        下の3つのうち、
        <strong>どれか1枚以上</strong>
        アップロードしてください。

        <br><br>

        足の形をより正確に確認するには、
        片足ずつ真正面から撮影した写真がおすすめです。
...
# =========================================================
    ...
    if shape == "エジプト型":
        ...
        shoe_detail = (
            "親指側を圧迫しにくく、"
            "つま先が自然に丸くなったタイプがおすすめです。"
            "親指の前に適度な余裕があるものを選びましょう。"
        )
