...
# =========================================================
    ...
    if color == "黄み強め":
        color_text = (
            ...
            "リフレクソロジーの考え方では、黄色っぽい足裏は、疲れやストレスがたまっている時のサインとして捉えることがあります。"
        ...
        color_text = (
            ...
            "リフレクソロジーの考え方では、赤みが強い時は、活動量が多い時や気持ちが高ぶっている時など、"
        ...
        color_text = (
            ...
            "リフレクソロジーの考え方では、紫っぽい色は、冷えや疲れが重なっている時など、"
        ...
        color_text = (
            ...
            "リフレクソロジーの考え方では、白っぽい足裏は、疲れや冷えを感じている時など、"
